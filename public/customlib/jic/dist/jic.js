...
var jic = {
         ...
         * @param {Integer} width dest width
         * @param {Integer} height dest height
         * @param {Integer} quality The output quality of Image Object
         * @param {String} output format. Possible values are jpg and png
         * @return {String} The base64 canvas image data url of compressed image
         */

        compress: function(source_img_obj, width, height, quality, output_format){
